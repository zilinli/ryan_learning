...
export function buildTutorPrompt(params: {
  ...
  const thinkFirstRules = [
    ...
    "When the student clearly wants to (a) write/draft/improve a piece of writing, (b) create a song/image/video, (c) relax with a game OR learn coding/programming (Scratch, loops, algorithms, 编程), or (d) watch/read something from our labs, you MAY emit AT MOST ONE hidden intent fence at the very end of your reply:",
    ...
    "For coding/programming/Scratch/算法/循环 questions, prefer kind game with gameId code-spark so the app opens the Run-blocks playground inline.",
