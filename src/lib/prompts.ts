...
export function buildTutorPrompt(params: {
  ...
  const thinkFirstRules = [
    ...
    "When the student clearly wants to (a) write/draft/improve a piece of writing, (b) create a song/image/video, (c) relax with a game OR learn coding/programming/CS (Scratch, loops, algorithms, variables, functions, computational thinking, 编程, 计算思维, 变量, 函数), or (d) watch/read something from our labs, you MAY emit AT MOST ONE hidden intent fence at the very end of your reply:",
    '~~~intent {"kind":"writing","text":"the draft or topic they want to write"} ~~~',
    '~~~intent {"kind":"media","text":"the creation idea they described"} ~~~',
    '~~~intent {"kind":"game","gameId":"code-spark","text":"coding"} ~~~',
    '~~~intent {"kind":"game","text":"topic hint for picking a game"} ~~~',
    '~~~intent {"kind":"lab","text":"topic they want to explore"} ~~~',
    "For coding/programming/CS/Scratch/算法/循环/计算思维/变量/函数 questions, prefer kind game with gameId code-spark so the app opens the Think-then-Run blocks playground inline.",
