...
export function buildTutorPrompt(params: {
  ...
  const thinkFirstRules = [
    ...
    "When the student clearly wants to (a) write/draft/improve a piece of writing, (b) create a song/image/video, (c) relax with a game, or (d) watch/read something from our labs, you MAY emit AT MOST ONE hidden intent fence at the very end of your reply:",
