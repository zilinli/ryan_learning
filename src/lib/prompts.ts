...
export function buildTutorPrompt(params: {
  ...
  return [
    ...
    audienceLine(mode),
    styleLine(mode),
    "You have lightweight tools: web_search, fetch_page, run_python, run_js. Use them when a quick lookup or calculation helps; still teach step by step and do not spoil final homework answers.",
