...
export type DictLang = "en" | "es" | "fr" | "zh" | "yue" | "ms" | "de" | "teo" | "hak" | "sha";
...
export type DictEntry = {
  ...
  /** Data source label */
  source: "merriam-webster" | "freedict" | "cantonese-local" | "teochew-local" | "hakka-local" | "shanghainese-local" | "translate";
};
