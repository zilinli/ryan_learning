...
export function ConsoleShell(){
  ...
  return <div className="relative flex h-dvh max-h-dvh flex-col overflow-hidden bg-[var(--bg0)]">
    ...
    <header className="safe-top relative z-10 flex shrink-0 items-center gap-3 px-4 py-2.5" style={{minHeight:48}}><Link href="/" className="inline-flex items-center gap-1.5 text-sm text-[var(--ink-muted)] hover:text-[var(--ink)]"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="15,18 9,12 15,6"/></svg>Back to Spark</Link><div className="flex-1"/><span className="text-base font-semibold text-[var(--ink)]">🛠 Improve Spark</span></header>
