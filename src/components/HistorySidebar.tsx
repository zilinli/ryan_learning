    ...
    <aside className="flex h-full w-[min(26rem,85vw)] flex-col border-r border-[var(--line)] bg-[color-mix(in_srgb,var(--bg0)_94%,white)]">
      ...
      <div className="shrink-0 border-t border-[var(--line)]/70 px-3 py-3">
        ...
        <div className="mb-2 grid grid-cols-2 gap-1.5">
          <a
            href="/deploy"
            className="flex min-h-10 items-center justify-center rounded-full border border-[var(--line)] bg-[var(--surface-muted)] px-2 text-[11px] font-semibold text-[var(--ink)] transition hover:bg-[var(--mist)]"
            title="One-click OpenClaw deploy on a PC"
          >
            Deploy PC
          </a>
          <a
            href="/control"
            className="flex min-h-10 items-center justify-center rounded-full border border-[var(--line)] bg-[var(--surface-muted)] px-2 text-[11px] font-semibold text-[var(--ink)] transition hover:bg-[var(--mist)]"
            title="Remote OpenClaw chat (replaces WeChat)"
          >
            Control
          </a>
        </div>
