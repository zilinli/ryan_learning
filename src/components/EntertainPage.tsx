...
const GAMES: GameInfo[] = [
  ...
  { id: "code-spark", title: "Code Spark", desc: "Blocks or Python missions — Code.org vibes, CodeCombat-style typed code", icon: "", category: "Learning Games" },
...
const STUDIO: StudioDest[] = [
  ...
  },
  {
    ...
    title: "BBC Doc Lab",
    kicker: "Listen",
    desc: "Documentary clips from BBC Earth — listen, then answer.",
    cta: "Open lab",
    tone: "cinema",
  },
  {
    ...
    title: "NatGeo Lab",
    kicker: "Watch & Read",
    desc: "Explore videos and articles, then answer challenges.",
    cta: "Open lab",
    tone: "cinema",
  },
  {
