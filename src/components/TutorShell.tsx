          ...
          <div className="flex min-w-0 items-center gap-2">
            ...
            <div className="min-w-0 lg:pl-1">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-1 inline-flex items-center gap-1 text-[11px] text-[var(--ink-muted)] underline-offset-2 transition hover:text-[var(--teal)] hover:underline sm:text-xs"
              >
                <GithubMark className="h-3.5 w-3.5 shrink-0 opacity-80" />
                {SPARK_GITHUB_LABEL}
              </a>
            </div>
          </div>
