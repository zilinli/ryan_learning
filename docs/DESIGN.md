...
| **[subsystems/german-language-support.md](subsystems/german-language-support.md)** | German (Deutsch) — Conrad edge-tts, Bailian STT hint `de`, dictionary/FAQ/Writing Pad |
